...
const allProjects = [
  ...
  },
  {
    id: 3,
    title: "NOVASOLVD",
    subtitle: "Enterprise IT Management",
    category: "Management",
    tags: ["React", "CI/CD", "Cloud"],
    description1: "Directed enterprise IT projects with clear roadmaps and measurable milestones. Modernized monolithic systems reducing operating costs by 20%.",
    description2: "Implemented automated CI/CD cutting release lead time by 40%.",
    img: "img/portfolio/2.jpg", 
    img2: "img/portfolio/2.jpg", 
  carousel_pictures:[],
    date: "2023",
  },
   {
